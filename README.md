...
|------|------|-------------|---------------|--------|
| 2026-08-01 | macOS 15.5 (Sequoia) | x86_64, Intel Core i7-6950X, AMD Radeon RX Vega 64, LunarG Vulkan SDK 1.4.350.1, MacPorts clang-17 | GPL + non-free, native build, openmp, `make_release: false` | Successful full build of FFmpeg 8.1 (`52/52` buildable components; libplacebo and Vulkan/OpenCL components added in subsequent session). HW accels confirmed: `videotoolbox`, `opencl`, `vulkan`. VideoToolbox encode/decode, OpenCL filters, Vulkan filters all present. |
